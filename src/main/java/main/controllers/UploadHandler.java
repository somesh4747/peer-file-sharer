...
public class UploadHandler implements HttpHandler {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        try (OutputStream os = exchange.getResponseBody()) {
            ...
            String requestString = baos.toString("ISO_8859_1"); // converting it into string using ISO charset to
                                                                // preserve binary data

            // String fileName = requestString.substring(requestString.indexOf("filename=")
            // + 10, requestString.indexOf("filename=") + 10 + 9);
            ...
            //
            // String fileHeader = "\r\n\r\n";
            // int fileStart = requestString.indexOf(fileHeader, matcher.end()) +
            // fileHeader.length();
            ...
            // String actualPathToSaveUploadData = uploadDir + File.separator +
